...
sudo apt-get install build-essential git zlib1g-dev libcairo2-dev libxt-dev libx11-dev libncurses5-dev libcurl3 php5-curl r-base-dev bedtools samtools bwa -y python-numpy cython default-jre ant --force-yes
